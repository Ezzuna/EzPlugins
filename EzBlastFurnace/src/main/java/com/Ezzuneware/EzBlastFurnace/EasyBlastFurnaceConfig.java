...
import com.Ezzuneware.EzBlastFurnace.config.PotionOverlaySetting;
import com.Ezzuneware.EzBlastFurnace.utils.BarsOres;
...
public interface EasyBlastFurnaceConfig extends Config {
    ...
    default boolean tickPerfectMethod() {
        return false;
    }
    ...
    @ConfigSection(
            name = "EzSettings",
            description = "EzSettings",
            position = 0
    )
    String EzSettingsSection = "EzSettingsSection";

    @ConfigItem(
            position = 0,
            keyName = "productName",
            name = "Product name (pick the bar!)",
            description = "PICK THE BAR!",
            section = EzSettingsSection
    )
    default BarsOres productName() {
        return BarsOres.GOLD_BAR;
    }
}
