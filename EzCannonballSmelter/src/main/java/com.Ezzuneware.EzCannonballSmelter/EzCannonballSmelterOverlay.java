...
public class EzCannonballSmelterOverlay extends OverlayPanel {

    private final Client client;
    private final EzCannonballSmelterPlugin plugin;

    @Inject
    private EzCannonballSmelterOverlay(Client client, EzCannonballSmelterPlugin plugin) {
        this.client = client;
        this.plugin = plugin;
