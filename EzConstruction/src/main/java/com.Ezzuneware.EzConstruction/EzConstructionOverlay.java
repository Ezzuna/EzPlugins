...
public class EzConstructionOverlay extends OverlayPanel {

    private final Client client;
    private final EzConstructionPlugin plugin;

    @Inject
    private EzConstructionOverlay(Client client, EzConstructionPlugin plugin) {
        this.client = client;
        this.plugin = plugin;
