...
public class EzMiningGuildIronMinerOverlay extends OverlayPanel {

    private final Client client;
    private final EzMiningGuildIronMinerPlugin plugin;

    @Inject
    private EzMiningGuildIronMinerOverlay(Client client, EzMiningGuildIronMinerPlugin plugin) {
        this.client = client;
        this.plugin = plugin;
