...
public class EzPlankMakerOverlay extends OverlayPanel {

    private final Client client;
    private final EzPlankMakerPlugin plugin;

    @Inject
    private EzPlankMakerOverlay(Client client, EzPlankMakerPlugin plugin) {
        this.client = client;
        this.plugin = plugin;
    ...
    public Dimension render(Graphics2D graphics) {
        ...
        panelComponent.getChildren().add(LineComponent.builder()
                .left("Region: ")
                .leftColor(Color.WHITE)
                .right(String.valueOf(plugin.getRegionId()))
                .rightColor(Color.WHITE)
                .build());
